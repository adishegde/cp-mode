...
/*
  ...
  class "output-buffer".
  - setOutput: Sets the value of the textarea to string passed as argument.
*/
...
export default function OutputBuffer() {
    ...
    // Define the setOutput function
    this.setOutput = function(text) {
        // Set value of textarea to passed text
        outputView.innerHTML = text;
    };
}
